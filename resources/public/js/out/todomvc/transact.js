...
log_event.cljs$lang$applyTo = (function (arglist__13152){
var db = cljs.core.first(arglist__13152);
arglist__13152 = cljs.core.next(arglist__13152);
var event = cljs.core.first(arglist__13152);
...
;
todomvc.transact.set_filter = (function set_filter(db,this_filter){console.log("set-filter: ",cljs.core.pr_str.call(null,this_filter));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db.fn","call","db.fn/call",2901959894),todomvc.transact.log_event,new cljs.core.Keyword(null,"set-filter","set-filter",2331384501),this_filter], null),(function (){var e = cljs.core.ffirst.call(null,datascript.q.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"find","find",1017047339),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1640529473,null)], null),new cljs.core.Keyword(null,"where","where",1127002201),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1640529473,null),new cljs.core.Keyword(null,"filter","filter",4034379498)], null)], null)], null),db));return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",1014207040),e,new cljs.core.Keyword(null,"filter","filter",4034379498),this_filter], null);
})()], null);
});
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__13160),iter__13157.call(null,cljs.core.chunk_rest.call(null,s__13158__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__13160),null);
}
} else
{var e = cljs.core.first.call(null,s__13158__$2);return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db.fn","retractEntity","db.fn/retractEntity",4213852396),e], null),iter__13157.call(null,cljs.core.rest.call(null,s__13158__$2)));
}
} else
{return null;
}
...
return (function (p__13174){var vec__13175 = p__13174;var _ = cljs.core.nth.call(null,vec__13175,0,null);var ___$1 = cljs.core.nth.call(null,vec__13175,1,null);var completed = cljs.core.nth.call(null,vec__13175,2,null);return completed;
});})(e_PLUS_id_PLUS_completed))
,e_PLUS_id_PLUS_completed));return cljs.core.into.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db.fn","call","db.fn/call",2901959894),todomvc.transact.log_event,new cljs.core.Keyword(null,"toggle-all","toggle-all",4455256858)], null)], null),(function (){var iter__11046__auto__ = (function iter__13176(s__13177){return (new cljs.core.LazySeq(null,(function (){var s__13177__$1 = s__13177;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__13177__$1);if(temp__4092__auto__)
{var s__13177__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__13177__$2))
{var c__11044__auto__ = cljs.core.chunk_first.call(null,s__13177__$2);var size__11045__auto__ = cljs.core.count.call(null,c__11044__auto__);var b__13179 = cljs.core.chunk_buffer.call(null,size__11045__auto__);if((function (){var i__13178 = 0;while(true){
if((i__13178 < size__11045__auto__))
{var vec__13182 = cljs.core._nth.call(null,c__11044__auto__,i__13178);var e = cljs.core.nth.call(null,vec__13182,0,null);var id = cljs.core.nth.call(null,vec__13182,1,null);var completed = cljs.core.nth.call(null,vec__13182,2,null);if(cljs.core._EQ_.call(null,completed,!(target)))
{cljs.core.chunk_append.call(null,b__13179,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",1014207040),e,new cljs.core.Keyword(null,"completed","completed",3905939901),target], null));
{
var G__13184 = (i__13178 + 1);
i__13178 = G__13184;
continue;
}
} else
{{
var G__13185 = (i__13178 + 1);
i__13178 = G__13185;
continue;
}
}
...
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__13179),iter__13176.call(null,cljs.core.chunk_rest.call(null,s__13177__$2)));
} else
{return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__13179),null);
}
} else
{var vec__13183 = cljs.core.first.call(null,s__13177__$2);var e = cljs.core.nth.call(null,vec__13183,0,null);var id = cljs.core.nth.call(null,vec__13183,1,null);var completed = cljs.core.nth.call(null,vec__13183,2,null);if(cljs.core._EQ_.call(null,completed,!(target)))
{return cljs.core.cons.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",1014207040),e,new cljs.core.Keyword(null,"completed","completed",3905939901),target], null),iter__13176.call(null,cljs.core.rest.call(null,s__13177__$2)));
} else
{{
var G__13186 = cljs.core.rest.call(null,s__13177__$2);
s__13177__$1 = G__13186;
continue;
}
}
}
