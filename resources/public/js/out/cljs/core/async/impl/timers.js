...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_24725 = 0;while(true){
if((i_24725 < arr.length))
{(arr[i_24725] = null);
{
...
{var i_24732 = (self__.level + 1);while(true){
if((i_24732 <= (new_level + 1)))
{(update[i_24732] = self__.header);
{
var G__24733 = (i_24732 + 1);
i_24732 = G__24733;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_24734 = 0;while(true){
if((i_24734 <= self__.level))
{var links_24735 = (update[i_24734]).forward;if(((links_24735[i_24734]) === x__$1))
{(links_24735[i_24734] = (x__$1.forward[i_24734]));
{
var G__24736 = (i_24734 + 1);
i_24734 = G__24736;
continue;
}
} else
{{
var G__24737 = (i_24734 + 1);
i_24734 = G__24737;
continue;
}
}
