...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_24354 = 0;while(true){
var m_24355 = cljs.core.async.impl.dispatch.tasks.pop();if((m_24355 == null))
{} else
{m_24355.call(null);
if((count_24354 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__24356 = (count_24354 + 1);
count_24354 = G__24356;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__10317__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__10317__auto__)
