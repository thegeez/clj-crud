...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_24760 = 0;while(true){
var m_24761 = cljs.core.async.impl.dispatch.tasks.pop();if((m_24761 == null))
{} else
{m_24761.call(null);
if((count_24760 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__24762 = (count_24760 + 1);
count_24760 = G__24762;
continue;
}
} else
{}
