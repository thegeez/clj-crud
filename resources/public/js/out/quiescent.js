...
*/
quiescent.component = (function component(renderer){var react_component = React.createClass({"render": (function (){var this$ = this;var _STAR_component_STAR_18269 = quiescent._STAR_component_STAR_;try{quiescent._STAR_component_STAR_ = this$;
return cljs.core.apply.call(null,renderer,(this$.props["value"]),(this$.props["statics"]));
}finally {quiescent._STAR_component_STAR_ = _STAR_component_STAR_18269;
...
var G__18270__delegate = function (value,static_args){return react_component.call(null,{"statics": static_args, "value": value});
};
var G__18270 = function (value,var_args){
var static_args = null;if (arguments.length > 1) {
  static_args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);} 
return G__18270__delegate.call(this,value,static_args);};
G__18270.cljs$lang$maxFixedArity = 1;
G__18270.cljs$lang$applyTo = (function (arglist__18271){
var value = cljs.core.first(arglist__18271);
var static_args = cljs.core.rest(arglist__18271);
return G__18270__delegate(value,static_args);
});
...
{var f = temp__4092__auto__;var _STAR_component_STAR_18272 = quiescent._STAR_component_STAR_;try{quiescent._STAR_component_STAR_ = this$;
return f.call(null,this$.getDOMNode());
}finally {quiescent._STAR_component_STAR_ = _STAR_component_STAR_18272;
}} else
{return null;
}
