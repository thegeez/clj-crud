...
{var pred__24069 = cljs.core._EQ_;var expr__24070 = limit;if(cljs.core.truth_(pred__24069.call(null,1,expr__24070)))
...
{var ch = s.charAt(index);var temp__4090__auto___24076 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___24076))
{var replacement_24077 = temp__4090__auto___24076;buffer.append([cljs.core.str(replacement_24077)].join(''));
} else
{buffer.append(ch);
}
{
