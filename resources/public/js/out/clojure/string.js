...
{{
var G__18383 = cljs.core.pop.call(null,v__$1);
v__$1 = G__18383;
continue;
}
} else
...
{var pred__18387 = cljs.core._EQ_;var expr__18388 = limit;if(cljs.core.truth_(pred__18387.call(null,1,expr__18388)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__18387.call(null,2,expr__18388)))
...
var G__18390 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__18391 = (limit__$1 - 1);
var G__18392 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__18390;
limit__$1 = G__18391;
parts = G__18392;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___18394 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___18394))
{var replacement_18395 = temp__4090__auto___18394;buffer.append([cljs.core.str(replacement_18395)].join(''));
} else
{buffer.append(ch);
}
{
var G__18396 = (index + 1);
index = G__18396;
continue;
}
}
