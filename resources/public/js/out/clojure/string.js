...
{{
var G__18340 = cljs.core.pop.call(null,v__$1);
v__$1 = G__18340;
continue;
}
} else
...
{var pred__18344 = cljs.core._EQ_;var expr__18345 = limit;if(cljs.core.truth_(pred__18344.call(null,1,expr__18345)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__18344.call(null,2,expr__18345)))
...
var G__18347 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__18348 = (limit__$1 - 1);
var G__18349 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__18347;
limit__$1 = G__18348;
parts = G__18349;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___18351 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___18351))
{var replacement_18352 = temp__4090__auto___18351;buffer.append([cljs.core.str(replacement_18352)].join(''));
} else
{buffer.append(ch);
}
{
var G__18353 = (index + 1);
index = G__18353;
continue;
}
}
