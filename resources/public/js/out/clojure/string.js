...
{{
var G__24591 = cljs.core.pop.call(null,v__$1);
v__$1 = G__24591;
continue;
}
} else
...
{var pred__24595 = cljs.core._EQ_;var expr__24596 = limit;if(cljs.core.truth_(pred__24595.call(null,1,expr__24596)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__24595.call(null,2,expr__24596)))
...
var G__24598 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__24599 = (limit__$1 - 1);
var G__24600 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__24598;
limit__$1 = G__24599;
parts = G__24600;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___24602 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___24602))
{var replacement_24603 = temp__4090__auto___24602;buffer.append([cljs.core.str(replacement_24603)].join(''));
} else
{buffer.append(ch);
}
{
