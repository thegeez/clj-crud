...
{{
var G__24284 = cljs.core.pop.call(null,v__$1);
v__$1 = G__24284;
continue;
}
} else
...
{var pred__24288 = cljs.core._EQ_;var expr__24289 = limit;if(cljs.core.truth_(pred__24288.call(null,1,expr__24289)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__24288.call(null,2,expr__24289)))
...
{var ch = s.charAt(index);var temp__4090__auto___24295 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___24295))
{var replacement_24296 = temp__4090__auto___24295;buffer.append([cljs.core.str(replacement_24296)].join(''));
} else
{buffer.append(ch);
}
{
var G__24297 = (index + 1);
index = G__24297;
continue;
}
}
