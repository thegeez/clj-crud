...
{{
var G__16669 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16669;
continue;
}
} else
...
{var pred__16673 = cljs.core._EQ_;var expr__16674 = limit;if(cljs.core.truth_(pred__16673.call(null,1,expr__16674)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16673.call(null,2,expr__16674)))
...
var G__16676 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16677 = (limit__$1 - 1);
var G__16678 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16676;
limit__$1 = G__16677;
parts = G__16678;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___16680 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___16680))
{var replacement_16681 = temp__4090__auto___16680;buffer.append([cljs.core.str(replacement_16681)].join(''));
} else
{buffer.append(ch);
}
{
var G__16682 = (index + 1);
index = G__16682;
continue;
}
}
